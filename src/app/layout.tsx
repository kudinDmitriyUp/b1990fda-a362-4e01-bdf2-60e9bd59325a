...
export const metadata: Metadata = {
  title: "webild - AI Website Generator | Build Sites in Minutes",
  description: "Create stunning, production-ready websites instantly with webild's AI-powered platform. No coding required. Generate, customize, and launch your site in minutes.",
  keywords: "AI website builder, website generator, no-code web design, instant website creation, AI design platform, website automation",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "webild - AI Website Generator",
    description: "Build production-ready websites in minutes with AI. No coding or design skills needed.",
    type: "website",
    siteName: "webild",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1765806577921-dfhja229.jpg",
      alt: "webild AI website generator dashboard"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "webild - AI Website Generator",
    description: "Create stunning websites instantly with AI",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1765806577921-dfhja229.jpg"]
  }
};
